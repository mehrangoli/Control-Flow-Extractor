 ...
 *****************************************************************************/
//--------------------->time g++ -g3 -o3 main.cpp bios.cpp paging.cpp icache.cpp fetch.cpp decode.cpp exec.cpp mmxu.cpp floating.cpp dcache.cpp pic.cpp -I /usr/local/systemc/include/ -L /usr/local/systemc/lib-linux64/ -o gdb_output_1bitadder -lsystemc -lm
/*****************************************************************************
